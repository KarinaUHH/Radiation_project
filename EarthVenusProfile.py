...
atm = xr.Dataset(
    {
        ...
        "CO2": ("alt", np.ones_like(pressure_profile) * 96.5*prozent),
        "N2": ("alt", np.ones_like(pressure_profile) * 03.5*prozent),
        "He": ("alt", np.ones_like(pressure_profile) * 12*ppm),
        "Ar": ("alt", np.ones_like(pressure_profile) * 70*ppm),
        "H2O": ("alt", np.ones_like(pressure_profile) * 30*ppm),
    },
